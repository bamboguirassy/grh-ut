 ...
 */
final class Version20210611084354 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE structure_fonction ADD rang INT NOT NULL, ADD appelation VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE structure_fonction DROP rang, DROP appelation');
    }
}
