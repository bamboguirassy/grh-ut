 ...
 */
final class Version20210518180141 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD commentaire_sortie LONGTEXT DEFAULT NULL, DROP retraite');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD retraite TINYINT(1) DEFAULT NULL COMMENT \'true ou false, false par defaut\', DROP commentaire_sortie');
